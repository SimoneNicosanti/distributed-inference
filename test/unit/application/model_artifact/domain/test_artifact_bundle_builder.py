...
from distributed_inference.application.model_artifact.domain.artifact_bundle_builder import (
...
def test_manifest_requires_an_entrypoint(tmp_path) -> None:
    with pytest.raises(ValueError):
        build_manifest_from_bundle_paths(ArtifactConcretePaths(root_path=tmp_path))
