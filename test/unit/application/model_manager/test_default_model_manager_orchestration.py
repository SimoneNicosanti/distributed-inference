...
from distributed_inference.application.model_manager.default_model_manager import (
    DefaultModelManager,
)
...
def test_generate_sub_model_splits_and_stores_component(tmp_path: Path) -> None:
    ...
    with patch(
        "distributed_inference.application.model_manager.default_model_manager."
