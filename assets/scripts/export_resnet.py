...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Export a torchvision ResNet to ONNX")
...
def main() -> None:
    ...
    if args.precision == "int8" and args.calibration_dir is None:
        raise ValueError("--calibration-dir is required for static INT8 ResNet export")
